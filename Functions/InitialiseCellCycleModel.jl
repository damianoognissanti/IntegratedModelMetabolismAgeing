...
function initialiseCellCycleModel()
    ...
    tspan = (1,350)
    #cell_cycle_prob = createCellCycleProblem(cell_cycle_sys, porig, u0orig, tspan)  
    cell_cycle_prob = ODEProblem(structural_simplify(cell_cycle_sys), u0orig, tspan, porig)
